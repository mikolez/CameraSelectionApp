...
public class Camera2VideoFragment extends Fragment
    ...
    public static boolean IS_MOVING_CAMERA = true;
    ...
    /* Fields for sensor data accumulation */
    ...
    /* Whether the camera is calibrated */
    public static boolean mIsCameraCalibrated;
    ...
    /* File for camera calibration data */
    private File cameraCalibrationFile;

    /* General data file */
    public static File generalDataFile;

    /* Rotation matrix for moving camera */
    public static File rotationMatrixDataFile;

    /* Arraylist to store rotation matrix data accumulated */
    public static ArrayList<float[]> rotationMatrixData;

    /* Arraylist of timestamps for the data collection */
    public static ArrayList<Long> timeData;
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        mCalibrationButton = view.findViewById(R.id.calibrationButton);
        ...
        switch (view.getId()) {
            case R.id.video: {
                if (mIsCameraCalibrated) {
                    ...
                    Toast.makeText(getContext(), "Camera is not calibrated yet", Toast.LENGTH_SHORT).show();
                    break;
                }
            }
            case R.id.calibrationButton: {
                if (!mIsCameraCalibrated) {
                    ...
                    /* Set up folder and video path */
                    String root = Environment.getExternalStorageDirectory().toString();
                    SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd_HHmmss");
                    String currentDateAndTime = sdf.format(new Date());
                    File myDir = new File(root + "/RMD_video/" + currentDateAndTime);
                    myDir.mkdirs();
                    mainFolder = myDir.toString();
                    videoPath = mainFolder + "/video.mp4";

                    /* Set up files */
                    cameraCalibrationFile = new File(myDir, "CameraCalibrationFile.txt");
                    generalDataFile = new File(myDir, "GeneralDataFile.txt");
                    if (IS_MOVING_CAMERA) {
                        rotationMatrixDataFile = new File(myDir, "RMD_MovingCamera.txt");
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            new TimeCalibration(getContext(), cameraCalibrationFile).execute();
                        }
                    }, 1000);
                    break;
                } else {
                    Toast.makeText(getContext(), "Camera is already calibrated", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
    ...
    private void stopRecordingVideo() {
        ...
        /* Get a server timestamp for video end */
